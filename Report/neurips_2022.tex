...
The numerical features are the features which have an inherent ordering...

The categorical features are those for which there is no inherent ordering. In this case it is increase_stock, hour...
